<script type="text/javascript">
    var url_source = "<?php echo base_url();?>admin/source";
    $(function() {
...
<script id="toolbar_template" type="text/x-kendo-template">
	<div>
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left;">
                <li>
                	<a _modal="dialog_infor_detail" _title="Thêm mới Nguồn dữ liệu" href="<?php echo base_url()?>admin/source/add" class="sys_modal">
...
<script type="text/javascript">
    function statuschange(id){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url();?>admin/source/onoff',
