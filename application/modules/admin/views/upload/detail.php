...
<form id="formSubmit" class="form-horizontal form-top" action="<?php echo $_SERVER['REQUEST_URI'];?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3 dialog-control" for="text1">Tiêu đề file</label>
    ...
    <div class="form-group">
        <label class="control-label col-sm-3 dialog-control" for="text1">Nguồn dữ liệu</label>
        <div class="col-sm-9 dialog-control">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3 dialog-control" for="text1">Trung tâm</label>
        <div class="col-sm-9 dialog-control">
