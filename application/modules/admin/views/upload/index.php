<script type="text/javascript">
    var url_introduced = "<?php echo base_url();?>admin/upload";
    $(function() {
...
<script id="toolbar_template" type="text/x-kendo-template">
	<div>
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left;">
                <li>
                	<a _modal="dialog_infor_detail" _title="Up dữ liệu khách hàng" href="<?php echo base_url()?>admin/upload/add" class="sys_modal">
