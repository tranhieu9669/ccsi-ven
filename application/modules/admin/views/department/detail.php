...
<form id="formSubmit" class="form-horizontal" role="form" method="POST" action="<?php echo $_SERVER['REQUEST_URI'];?>" autocomplete="off">
    ...
    <div class="form-group">
  	...
  	<div class="form-group">
    	<label class="control-label col-sm-2 dialog-control" for="pwd">Tên phòng ban </label>
    	<div class="col-sm-10 dialog-control">
      	<input type="text" name="name" class="form-control" placeholder="Tên phòng ban" value="<?php echo set_value_input('name', $detail);?>">
