<script type="text/javascript">
    var url_introduced = "<?php echo base_url();?>admin/department";
    $(function() {
        ...
        var grid_config = {
            ...
            'columns': [
                ...
                { field: "edit", title: 'Sửa', width: column_properties._wth_action, sortable: false, template: function(data){
                    var html = '<a _modal="dialog_infor_detail" _title="Sửa thông tin Phòng ban" href="<?php echo base_url();?>admin/department/edit/' + data.id + '" class="sys_modal btn btn-primary btn_edit btn-default">';
                    html = html + 'Sửa';
                    html = html + '</a>';
                    return html;
                }},
...
<script id="toolbar_template" type="text/x-kendo-template">
	<div>
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left;">
                <li>
                	<a _modal="dialog_infor_detail" _title="Thêm mới Phòng ban" href="<?php echo base_url()?>admin/department/add" class="sys_modal">
...
<script type="text/javascript">
    function statuschange(id){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url();?>admin/department/onoff',
