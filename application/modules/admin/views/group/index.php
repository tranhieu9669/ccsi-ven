<script type="text/javascript">
    var url_introduced = "<?php echo base_url();?>admin/group";
    $(function() {
        ...
        var grid_config = {
            ...
            'columns': [
            	...
            	{ field: "cename", title: 'Tên Trung tâm', sortable: false,},
                { field: "dename", title: 'Tên Phòng ban', sortable: false,},
                { field: "grname", title: 'Tên Nhóm', sortable: false,},
                ...
                { field: "edit", title: 'Sửa', width: column_properties._wth_action, sortable: false, template: function(data){
                    var html = '<a _modal="dialog_infor_detail" _title="Sửa thông tin Nhóm" href="<?php echo base_url();?>admin/group/edit/' + data.id + '" class="sys_modal btn btn-primary btn_edit btn-default">';
                    html = html + 'Sửa';
                    html = html + '</a>';
                    return html;
                }},
...
<script id="toolbar_template" type="text/x-kendo-template">
	<div>
        <span class="pull-left">
            <ul class="fieldlist" style="float:left;">
                <li>
                    ...
                    <span class="title-template-grid">Danh sách Nhóm</span>
                </li>
            </ul>
        </span>
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left;">
                <li>
                	<a _modal="dialog_infor_detail" _title="Thêm mới Nhóm" href="<?php echo base_url()?>admin/group/add" class="sys_modal">
...
<script type="text/javascript">
    function statuschange(id){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url();?>admin/group/onoff',
