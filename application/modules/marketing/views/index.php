...
<script type="text/javascript">
    var url = "<?php echo base_url();?>marketing";
    ...
    $(function() {
        ...
        var grid_config = {
            ...
            'columns': [
                ...
                { field: "agent_ext", title: 'Agent', width: 85, sortable: false,},
                ...
                /*{ field: "call", title: 'Gọi', width: column_properties._wth_action, sortable: false,template: function(data){
                    var html = '<a href="<?php echo base_url();?>group/callappointment/' + data.id + '" class="btn btn-primary btn_edit btn-default">';
...
<script id="toolbar_template" type="text/x-kendo-template">
	<div>
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left;">
                <li>
                    <a _modal="dialog_infor_detail" _title="Thêm mới lịch hẹn" href="<?php echo base_url();?>marketing/detail" class="sys_modal">
                        <span class="glyphicon glyphicon-link" aria-hidden="true"></span> Thêm mới hẹn
                    </a>
                </li>
            </ul>
        </span>
