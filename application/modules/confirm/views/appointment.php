...
<script type="text/javascript">
    var url = "<?php echo base_url();?>confirm/appointment";
    ...
    $(function() {
		...
		{ field: "app_created_at", title: 'T/G Tạo', width: column_properties._wth_time, sortable: false,},
                { field: "call", title: 'Gọi', width: column_properties._wth_action, sortable: false,template: function(data){
                    var html = '<a href="<?php echo base_url();?>confirm/appointment/call/' + data.id + '" class="btn btn-primary btn_edit btn-default">';
