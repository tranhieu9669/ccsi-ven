...
<form id="call_log" method="POST" action="<?php echo $_SERVER['REQUEST_URI'];?>" autocomplete="off">
						    	...
						    	<ul class="fieldlist" style="margin:0px;">
						            ...
						            <li style="margin-left: 35px;">
					             	...
					             	<li style="margin-left: 35px;">
					              	...
					              	<li style="margin-left: 35px;">
					                  	<input type="radio" name="app_status" id="app_status_cancel" value="cancel" class="k-radio" >
					                  	<label class="k-radio-label" for="app_status_cancel">Cancel</label>
					              	</li>
						        </ul>
						    </div>

						    <label class="control-label col-sm-2 padding-left-15" for="pwd">Gửi lại SMS <span class="validation">*</span></label>
						    <div class="col-sm-4 box-row">
						    	<input type="checkbox" name="resendSMS" id="resendSMS" value="Yes">
						    </div>
					  	</div>
					</div>
					<div class="col-sm-6 box-item">
	...
	<div class="container-fluid box-infor">
		...
		<?php if(isset($appointmentdt['cus_mobile']) AND !empty($appointmentdt['cus_mobile'])){ ?>
