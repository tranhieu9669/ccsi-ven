...
<script type="text/javascript">
    var url = "<?php echo base_url();?>group/call/appointment";
    ...
    $(function() {
        ...
        var grid_config = {
            ...
            'columns': [
                ...
                { field: "agent_ext", title: 'Agent', width: 65, sortable: false,},
                ...
                { field: "call", title: 'Gọi', width: column_properties._wth_action, sortable: false,template: function(data){
                    ...
                    var html = '';
                    if(crm_status == null || parseInt(crm_status)==5){
                        html = '<a href="<?php echo base_url();?>group/callappointment/' + data.id + '" class="btn btn-primary btn_edit btn-default">';
...
<script id="toolbar_template" type="text/x-kendo-template">
	<div>
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left; display:block;">
                <li>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#exportData').click(function(){
            ...
            var id_center = $('#id_center').val();
            _param += '&id_center='+id_center;
            var _url = '<?php echo base_url()."group/call/exappointment";?>' + _param;
            $(this).attr('href', _url);
        });
    });
