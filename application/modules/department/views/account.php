...
<script type="text/javascript">
    var url = "<?php echo base_url();?>department/account";
    ...
    $(function() {
        ...
        var grid_config = {
            ...
            'columns': [
                ...
                { field: "full_name", title: 'Full Name', sortable: false, template: '#=ColorTextSearch(full_name)#'},
                { field: "mobile", title: 'Mobile', width: column_properties._wth_mobile, sortable: false, template: '#=ColorTextSearch(mobile)#'},
                { field: "ext", title: 'EXT', width: column_properties._wth_ext, sortable: false,},
                { field: "roles", title: 'Role', width: column_properties._wth_role, sortable: false,},
                { field: "dbname", title: 'DB Name', width: column_properties._wth_dbname, sortable: false,},
            ]
        };
