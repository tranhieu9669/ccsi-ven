...
<script id="toolbar_template" type="text/x-kendo-template">
    <div>
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left;">
                <li>
                    <a _modal="dialog_infor_detail" _title="Thêm mới giới hạn" href="<?php echo base_url()?>limit/center/add" class="sys_modal">
...
<script type="text/javascript">
    var url = "<?php echo base_url();?>limit/center";
    ...
    $(function() {
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        ...
                        cenname: { type: "string", editable: false, },
                        faname: { type: "string", editable: false, },
        ...
        $("#grid").kendoGrid({
            ...
            columns: [
                { field: "cenname", title: 'Center', sortable: false, },
                { field: "faname", title: "frametime",  width: column_properties._wth_faname, },
                { field: "date", title: "Date", width: column_properties._wth_date, },
                { field: "limited", title: "Limit", width: column_properties._wth_number, },
                { field: "appointment", title: "App", width: column_properties._wth_number, },
                { command: [ 
