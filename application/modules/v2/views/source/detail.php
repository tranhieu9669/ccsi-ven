...
<form id="formSubmit" class="form-horizontal" role="form" method="POST" action="<?php echo $_SERVER['REQUEST_URI'];?>" autocomplete="off">
  	...
  	<div class="form-group">
    	<label class="control-label col-sm-3 dialog-control" for="pwd">Nguồn dữ liệu </label>
    	<div class="col-sm-9 dialog-control">
      	<input type="text" name="name" class="form-control" placeholder="Nguồn dữ liệu" value="<?php echo set_value_input('name', $detail);?>">
