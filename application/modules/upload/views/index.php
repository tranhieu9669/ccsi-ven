	...
	<div>
        <span class="pull-left">
            <ul class="fieldlist" style="float:left;">
                <li>
                    <a href="<?php echo base_url()?>data/upload/file"><span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span> File dữ liệu</a>
                </li>
            </ul>
        </span>
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left;">
                <li>
                	<a _modal="dialog_infor_detail" _title="Up dữ liệu khách hàng" href="<?php echo base_url()?>data/upload/add" class="sys_modal">
