<script type="text/javascript">
    var url = "<?php echo base_url();?>support";
    $(function() {
        ...
        var grid_config = {
            ...
            'columns': [
                ...
                { field: "roles", title: 'Quyền', width: 75, sortable: false,},
                ...
                { field: "edit", title: 'Sửa', width: column_properties._wth_action, sortable: false, template: function(data){
                    var html = '<a _modal="dialog_infor_detail" _title="Sửa thông tin tài khoản" href="<?php echo base_url();?>support/account/edit/' + data.id + '" class="sys_modal btn btn-primary btn_edit btn-default">';
                    html = html + 'Sửa';
                    html = html + '</a>';
                    return html;
                }},
	...
	<div>
        <span class="pull-left">
            <ul class="fieldlist" style="float:left; margin-left:0px;">
                ...
                <li style="width:200px;">
                    <select id="_id_group" name="_id_group" class="form-control-select">
        ...
        <span class="pull-right">
            <ul class="fieldlist" style="float:left;">
                <li>
                    ...
                    <a _modal="dialog_infor_detail" _title="Thêm thông tin Tài khoản" href="<?php echo base_url()?>support/account/add" class="sys_modal" style="margin-right: 5px;">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>Thêm tài khoản
                    </a>

                    <a _modal="dialog_infor_detail" _title="Thêm danh sách Tài khoản" href="<?php echo base_url();?>support/account/addlist" class="sys_modal">
...
<script type="text/javascript">
    function statuschange(id){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url();?>support/account/onoff',
        ...
        $("#_id_department").change(function(){
            ...
            $.ajax({
              ...
              success : function( data ) {
                ...
                var html_group = '<option value="0" selected="selected"> Nhóm</option>';
                ...
                $('#_id_group').html(html_group);
                $("#_id_group").select2("val", "0");
              },
