...
<script type="text/javascript">
    var url = "<?php echo base_url();?>staff/call/nostatus";
    ...
    $(function() {
        ...
        var grid_config = {
            ...
            'columns': [
				...
				{ field: "customer", title: 'Khách hàng', width: column_properties._wth_customer, sortable: false,},
                ...
                { field: "call", title: 'Gọi', width: column_properties._wth_action, sortable: false,template: function(data){
                    var html = '<a href="<?php echo base_url();?>staff/edit/' + data.id + '" class="btn btn-primary btn_edit btn-default">';
