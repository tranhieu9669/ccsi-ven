...
<script type="text/javascript">
    var url = "<?php echo base_url();?>staff/call/misscall";
    ...
    $(function() {
        ...
        var grid_config = {
            ...
            'columns': [
                ...
                { field: "mobile", title: 'Số khách hàng', width: column_properties._wth_customer, sortable: false, template: '#=ColorTextSearch(mobile)#'},
                { field: "calldate", title: 'Thời gian gọi', sortable: false,},
            ]
        };
