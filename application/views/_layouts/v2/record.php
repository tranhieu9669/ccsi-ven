...
<body>
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
                <li class="<?php echo $home;?>">
                    <a href="<?php echo base_url().$this->_role;?>">Cuộc gọi Out</a>
                </li>

                <li class="<?php echo $home;?>">
                    <a href="<?php echo base_url().$this->_role.'/in';?>">Cuộc gọi In</a>
                </li>

                <li class="<?php echo $home;?>">
                    <a href="<?php echo base_url().$this->_role.'/appointment';?>">Lịch hẹn</a>
                </li>
            </ul>
            <!-- Right nav --> 
    ...
    <script type="text/javascript">
        $(function(){
            ...
            init_modal('#dialog_infor_detail', '', '500px');
