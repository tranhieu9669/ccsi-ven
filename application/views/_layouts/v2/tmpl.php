...
<body>
	<div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">            
            <a class="navbar-brand" title="User Center" href="/">
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
                <li class="<?php echo $home;?>">
                    <a href="<?php echo base_url(); ?>">Trang chính</a>
                </li>

                <?php if( in_array($this->_role, array('supadmin', 'admin')) ){ ?>
                <li class="">
                    <a target="_blank" href="<?php echo base_url() . 'account/activeacc';?>">Kích hoạt tài khoản</a>
                </li>
                <?php } ?>
            </ul>
            <!-- Right nav --> 
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a _modal="dialog_infor_detail" _title="Thay đổi mật khẩu" href="<?php echo base_url() . 'account/changepass';?>" class="sys_modal">Đổi mật khẩu</a></li>
    ...
    <div class="col-sm-2">
        <?php
            include_once('includes/mn_' . $nm_select . '.php');
        ?>
    </div>
    <div class="col-sm-10">
        <?php
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#dialog_detail").data("kendoWindow").bind('close', function(){
                //
            });

            $("#dialog_infor_detail").data("kendoWindow").bind('close', function(){
                //
            });
        });
    </script>
